...
username_entry = tk.Entry(root, fg="pink")  
username_entry.pack()
...
length_entry = tk.Entry(root, fg="blue")  
length_entry.pack()
...
special_chars_check = tk.Checkbutton(root, text="Include special characters", variable=special_chars_var, fg="orange")  
...
reset_button = tk.Button(root, text="Reset", command=lambda: password_label.config(text=""), fg="white", bg="black")  
